Name: rnp
Summary: Mucse(R) 1/10/25/40GbE PCI Express Linux Network Driver
Version: 0.2.0
Release: 1
Source: %{name}-%{version}.tar.gz
Vendor: Mucse Corporation
License: GPL-2.0
ExclusiveOS: linux
Group: System Environment/Kernel
Provides: %{name}
URL: http://www.mucse.com
...
%description
This package contains the Mucse(R) 1/10/40GbE PCI Express Linux Network Driver.
...
<<"END"
#! /bin/bash
# Copyright (C) 2017 Mucse Corporation
